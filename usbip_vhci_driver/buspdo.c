...
--*/
{
    ...
    case IRP_MN_START_DEVICE:
        ...
        // Power up the device.
        //
        DeviceData->cda.DevicePowerState = PowerDeviceD0;
...
--*/
{
    ...
    case TargetDeviceRelation:
        ...
        deviceRelations->Objects[0] = DeviceData->cda.Self;
        ObReferenceObject(DeviceData->cda.Self);
...
--*/
{
    InterlockedIncrement((volatile LONG*)&((PPDO_DEVICE_DATA)Context)->InterfaceRefCount);
}
...
--*/
{
    InterlockedDecrement((volatile LONG*)&((PPDO_DEVICE_DATA)Context)->InterfaceRefCount);
}
...
--*/
{
    ...
    DeviceCapabilities->Address = (ULONG)~0;
    DeviceCapabilities->UINumber = (ULONG)~0;
